...
from serve.global_vars import USE_CACHE
...
def get_context_prompt(prompt_name: str, context_mode: str) -> str:
    assert context_mode in ["no_context", "centered", "red_bbox"], f"Invalid context mode: {context_mode}"
